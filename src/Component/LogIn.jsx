...
const LogIn = () => {
  ...
  return (
    <div className='mt-3'>
        <form onSubmit={handleSubmit} action="" className='mx-auto col-11 col-md-6 col-lg-5 shadow rounded-4 p-4 mt-5'>
            <h2 className='text-center text-info fs-1'>Log In</h2>
            ...
            <button className='btn btn-info w-100 mt-4 text-secondary fw-bold' type="submit">Log In</button>
        </form>
        <div className='d-flex justify-content-center mt-3 gap-2'>
            <p>Don't  have an account?</p>
            <Link className='link-info' to="/sign-up">Sign Up</Link>
        </div>
    </div>
  )
}
